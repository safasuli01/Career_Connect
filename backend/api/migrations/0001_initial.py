...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('post_type', models.CharField(choices=[('job', 'Job'), ('project', 'Project')], max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company_type', models.CharField(choices=[('hiring', 'Hiring'), ('seeking', 'Seeking')], default='hiring', max_length=12)),
