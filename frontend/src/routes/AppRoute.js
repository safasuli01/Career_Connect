    ...
    <AuthProvider> {/* Wrap the Router inside the AuthProvider */}
      <Router>
        ...
        <Routes>
          ...
          <Route path="/individual/:id/profile" element={<Profile />} /> {/* Uncommented the individual profile route */}
          <Route path="/author-profile/:id" element={<Profile />} /> {/* Depending on how you handle the author vs. individual */}
